  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between items-center bg-animated-gradient relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center justify-center w-full flex-1">
        <form className="backdrop-blur-xl bg-white/20 border border-white/30 shadow-2xl rounded-2xl px-8 py-10 w-full max-w-md animate-cardIn" onSubmit={handleSubmit}>
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-8 tracking-wide animate-fadeIn">Sign in to your account</h2>
          {/* Username */}
          <div className="mb-6">
          ...
          {/* Error Message */}
          {error && <div className="mb-4 text-red-600 text-center text-sm font-medium animate-fadeIn">{error}</div>}
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="#" className="text-xs text-gray-700 hover:underline transition-colors">Forgot Password?</Link>
          </div>
          {/* Login Button */}
          <Button type="submit" className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold py-3 rounded-xl shadow-lg transition-transform duration-200 hover:scale-105 animate-btnIn text-lg tracking-wide">LOGIN</Button>
          {/* Demo Login Button */}
          <Button
            type="button"
            className="w-full mt-3 bg-gray-200 hover:bg-gray-300 text-gray-900 font-semibold py-3 rounded-xl shadow transition-transform duration-200 hover:scale-105 animate-btnIn text-lg tracking-wide"
          ...
          <div className="text-center mt-6">
            ...
            <Link to="/signup" className="text-gray-900 font-medium hover:underline transition-colors">Sign up</Link>
          </div>
        </form>
      </div>
    </div>
